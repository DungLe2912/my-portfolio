...
import { getGithubDetails } from "utils/apiServices"

import { IRepoData } from "utils/types"

export default function RepoDetails(): JSX.Element {
  const [repoData, setRepoData] = useState<IRepoData | undefined>(undefined)
  useEffect(() => {
    getGithubDetails().then((result: IRepoData | undefined) => {
      setRepoData(result)
    })
  }, [])
  return (
          ...
          <div className="col-span-12 md:col-span-7 lg:col-span-6 flex flex-col justify-center items-center">
            ...
            <div className="items-center w-3/4">
              ...
              <p className="italic text-purple-50 text-sm mt-8">
                *The vectors/icons are picked from various sources from the internet. <br />
              </p>
            </div>
          </div>
          {repoData && (
